...
# Load data ----
here_output_files <- here(path_project, "outputs", "models", "models-cco-wbgt")
df_full_models <- read.csv(here(here_output_files, "models_consolidated_cco_wbgt.csv"))
dim(df_full_models)

# Constants ---------------
## Call the function to plot ----
source(here("codes", "helper-functions", "function-to-plot-models-and-effect-modifiers.R"))
## Path for outputs ----
path_out <- here(path_project, "outputs", "figures", "cco-wbgt")
