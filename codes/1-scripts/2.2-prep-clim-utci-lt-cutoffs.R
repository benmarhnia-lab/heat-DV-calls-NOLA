...
df_cutoffs_rolling_85 <- flexi_percentile_cutoffs(DT = df_temp_data_nola, var_col = "utci_mean", 
                                ntile = 0.85, 
                                perc_type = "rolling", 
                                num_days = 3, 
                                psu_col = "Zip", 
...
df_cutoffs_rolling_90 <- flexi_percentile_cutoffs(DT = df_temp_data_nola, var_col = "utci_mean", 
                                ntile = 0.90, 
                                perc_type = "rolling", 
                                num_days = 3, 
                                psu_col = "Zip", 
...
df_cutoffs_rolling_95 <- flexi_percentile_cutoffs(DT = df_temp_data_nola, var_col = "utci_mean", 
                                ntile = 0.95, 
                                perc_type = "rolling", 
                                num_days = 3, 
                                psu_col = "Zip", 
