...
# Read data ----
df_temp_data_nola <- read_fst(here(path_processed_data, "2.5_nola_heat_index_zip_code.fst"), as.data.table = TRUE)
...
# Save Work
write_fst(df_temp_data_nola, path = here(path_processed_data, "2.6-clim-vars-heat-index.fst"))
