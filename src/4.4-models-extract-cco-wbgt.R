...
model_outputs <- readRDS(here(path_processed, "4.3-models-cco-wbgt.rds"))
...
saveWorkbook(wb, here(path_out, "models_cco_wbgt.xlsx"), overwrite = TRUE)
...
write.csv(combined_exposures, here(path_out, "models_consolidated_cco_wbgt.csv"), row.names = FALSE)
