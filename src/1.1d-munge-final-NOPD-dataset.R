...
# The final dataset is saved as 1.3-DV-cases-agg.fst.
...
df_nopd_dv_cases <- read_fst(here(path_processed_data, "1.1c-nopd-calls-raw-dv-only-completed.fst"), 
    as.data.table = TRUE)
...
# Save file ----
write_fst(df_dv_cases_agg, here(path_processed_data, "1.1d-DV-cases-agg.fst"))
