...
write_fst(df_cutoffs_rolling_95, here(path_processed_data, "2.2c_nola_tmax_zip_code_cutoffs_rolling_90.fst"))
...
df_merged <- merge(df_nola_zip_tmax, df_lt_cutoff_all, by = c("date", "Zip"), all = TRUE)

# Save the final dataset ----
write.fst(df_merged, here(path_processed_data, "2.2_nola_tmax_zip_cutoffs_added_90.fst"))
