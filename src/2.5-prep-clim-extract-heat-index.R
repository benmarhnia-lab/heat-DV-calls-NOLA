...
path_wbgt_data <- here("data", "raw-data", "heat-index-ecmwf") 
...
# Save file
write_fst(df_nola_zip_temp, here(path_processed_data, "2.5_nola_heat_index_zip_code.fst"))

# df_nola_zip_temp <- read_fst(here(path_processed_data, "2.5_nola_heat_index_zip_code.fst"), as.data.table = TRUE)
